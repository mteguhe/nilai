...
if(isset($_POST['kirim'])){
	...
	$query=mysql_query("insert into `data_pelajaran` values('','$nama_pelajaran')");
...
?>
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Update Nilai</h1>
	<div class="line"></div>
    ...
    <form action="tambah_pelajaran.php" method="post">
            ...
            <table border="1" width="75">
                ...
                <tr align="center">
                    ...
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='T1".$nomor."' maxlength='3' size='20' value='".$row2['tugas_1']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='T2".$nomor."' maxlength='3' size='20' value='".$row2['tugas_2']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='T3".$nomor."' maxlength='3' size='20' value='".$row2['tugas_3']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                   
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='U1".$nomor."' maxlength='3' size='20' value='".$row2['ujian_1']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='U2".$nomor."' maxlength='3' size='20' value='".$row2['ujian_2']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='U3".$nomor."' maxlength='3' size='20' value='".$row2['ujian_3']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='UTS".$nomor."' maxlength='3' size='20' value='".$row2['UTS']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    
                    <td><?php echo "<input type='text' class='inp-form-rad2' name='UAS".$nomor."' maxlength='3' size='20' value='".$row2['UAS']."'
                    onKeypress='if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;'"; ?>
                    onBlur="if(this.value=='')this.value='0'" onFocus="if(this.value=='0')this.value=''" /></td>
                    ...
                    <tr>                      
                      <td valign="top" colspan="10"><input type="submit" name="update" value="" class="form-submi" /></td>
                    </tr>
                </table>
