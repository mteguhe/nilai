    	   ...
    	   <form action="data_siswa.php" method="post">
            ...
            <table border="1" width="75">
                ...
                <?php
					...
					$querycari  = "SELECT * FROM ruang_kelas kelas, user_siswa siswa, data_kelas data where kelas.nis=siswa.nis and data.id_kelas=kelas.id_kelas $filter_nis $filter_nama $filter_kelas";
                    ...
                    <tr>
                        ...
                        <td align="center"> 
                        <a class="icon-1 info-tooltip" href="edit_siswa.php?id_siswa_edit=<?php echo $row['id_siswa'] ?>"> </a> 
                        </td>
                    ...
                    <td colspan="7" ><input type="submit" name="update" value="" class="form-submi" /></td>
                    </tr>
